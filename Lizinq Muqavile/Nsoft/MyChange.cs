...
namespace Nsoft
{
    class MyChange
    {
        ...
        public static string Mezenne(string valyuta)
        {
            string[] arr = { "https://www.cbar.az/", "", "1.0000" };
            ...
            try
            {
                ...
                {
                    if (arr[1].Substring(k, 5) == "1 " + valyuta)
                    {
        ...
        {
            string[] arr = { "http://www.euronews.com/weather/europe/azerbaijan/baku", "", "-" };
            ...
            try
            {
                ...
                for (int k = 0; k < arr[1].Length; k++)
                {
                    if (arr[1].Substring(k, 5) == "C ltr")
                    {
                        arr[2] = arr[1].Substring(k + 17, 3); // hava temperaturunun kordinasiyasi
                        break;
                    }
                }
